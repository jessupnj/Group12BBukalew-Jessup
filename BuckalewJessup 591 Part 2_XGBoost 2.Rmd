...
```{r}
roc_default_auc <- ROCR::performance(pred_default, "auc")
roc_pruned_auc <- ROCR::performance(pred_pruned, "auc")
roc_default_auc <-roc_default_auc@y.values[[1]]
roc_pruned_auc <-roc_pruned_auc@y.values[[1]]
print(paste("Default Tree: ",roc_default_auc))
print(paste("Pruned Tree: ",roc_pruned_auc))
```
